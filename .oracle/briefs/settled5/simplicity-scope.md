# Settled-plan wave 5 — simplicity-scope
...
Challenge whether the complete stable plan reaches the frozen outcome with the minimum necessary machinery, declarations, artifacts, and handoffs. Look for ceremony reintroduced by the admission/Runaway corrections. Do not rewrite the plan.
