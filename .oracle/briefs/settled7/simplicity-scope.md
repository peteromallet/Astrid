# Settled-plan wave 7 — simplicity-scope
...
Challenge the proof-complete stable plan for unnecessary machinery, duplicated validation, speculative interfaces, or ceremony that can be cut without weakening a frozen criterion. Do not rewrite the plan.
