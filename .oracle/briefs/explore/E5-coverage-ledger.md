Inventory all existing bundled custom extension surfaces that the zero-unclassified ledger must cover. Propose a mechanically discoverable taxonomy and evidence sources for pack versus irreducible-kernel ownership without turning the ledger into runtime configuration.
