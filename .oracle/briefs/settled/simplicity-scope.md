# Settled-plan wave 1 — simplicity-scope
...
Challenge whether the outcome can be reached with less work, fewer abstractions, fewer handoffs, or narrower declarations. Flag speculative layers, duplicated concepts, and scope that does not pull its weight. Do not rewrite the plan.
