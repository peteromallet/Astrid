...
READY_METADATA = ReadyMetadata.build(
    ...
    models=MODELS,
    requirements={'missing_nodes': ['MiniMaxH3AVExtensionController', 'MiniMaxH3AVSourceAudioModeParam', 'MiniMaxH3AVStartModeParam', 'MiniMaxH3AudioVAECompatibility', 'MiniMaxH3CropTo32', 'MiniMaxH3CustomKeyframes', 'MiniMaxH3FinalizeVHSOutput', 'MiniMaxH3GeneratedAVMaskedContext', 'MiniMaxH3LastActiveVHSPreviewBarrier', 'MiniMaxH3SourceAudioPolicy', 'MiniMaxH3SourceAudioRegenLength', 'MiniMaxH3SourceAudioRegenMask', 'MiniMaxH3StartCanvasSelector', 'MiniMaxH3StartMaskedContext', 'MiniMaxH3StreamLiveExtensionAVToVHS', 'MiniMaxH3Validate24FPSVideo', 'Note'], 'custom_nodes': ['ComfyUI-H3-Motion-Context-MultiRef', 'ComfyUI-VideoHelperSuite'], 'runtime': {'comfy_commit': 'ee71d5c4993f29086b27fde1629a945ae48425bf', 'comfy_version': '==0.36.0', 'packages': {'comfy-aimdo': '==0.5.3', 'comfy-kitchen': '==0.2.34', 'torch': '==2.10.0+cu130'}, 'launch_flags': ['--use-ck-attention', '--disable-comfy-compiler']}},
