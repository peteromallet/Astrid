...
[the opening animation execution record](astrid-intro-animation-execution.md).
...
[`astrid_intro_h3_prompts.json`](../workflows/astrid_intro_h3_prompts.json).
The new starter/continuation recipe is
[`astrid_intro_h3_anchor_chain/workflow.py`](../workflows/astrid_intro_h3_anchor_chain/workflow.py).
