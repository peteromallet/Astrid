# Settled-plan wave 2 — reuse-architecture
...
Challenge the complete revised architecture for disguised parallel authorities, over-broad catalog ownership, duplicated DDL/docs/runtime state, insufficient reuse, or unnecessary registry/factory redesign. Check the field contract, resource invariant, and algorithmic composition. Do not rewrite the plan.
