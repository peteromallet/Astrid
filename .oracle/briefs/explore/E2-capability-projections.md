Explore every typed capability registry and its pack discovery inputs: executors, orchestrators, elements, rendering, generation, aliases, forks, overrides, priorities, caches, skills, and agent index. Separate reusable typed mechanics from duplicated identity/discovery/trust authority.
