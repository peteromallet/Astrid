...
# Stitching reuses the registered public renderer. The runtime dependency
# continuation supplies ordered predecessor outputs; no unregistered synthetic
# capability is emitted.
STITCH_CAPABILITIES = {
