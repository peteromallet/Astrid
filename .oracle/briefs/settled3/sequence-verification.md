# Settled-plan wave 3 — sequence-verification
...
Challenge dependency order, snapshot freshness, database-head semantics, hard-deletion timing, cumulative boundaries, coverage/resource generation, single-wheel proof, and criterion traceability. Find unsafe sequencing, stale-state risks, redundant verification, or missing proof. Do not rewrite the plan.
