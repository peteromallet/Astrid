# Settled-plan wave 1 — reuse-architecture
...
Challenge whether the plan reuses existing mechanisms maximally and preserves clear ownership. Look for disguised parallel authorities, a universal service locator, duplicated DDL/docs/runtime state, or unnecessary registry/factory redesign. Do not rewrite the plan.
