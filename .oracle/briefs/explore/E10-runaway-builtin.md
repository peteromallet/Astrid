Prove runaway's current extended-only semantics and every impact of including it in standard bundled database composition. Determine whether builtin and builtin.* aliases own current behavior or only compatibility residue. Identify exact tests/data-open scenarios needed for a safe hard cut.
