Inventory every bundled pack's AGENTS.md and skill/SKILL.md, current manifest declarations, user/agent-facing status, legitimate internal opt-outs, skill discovery behavior, _core generator inputs, and existing tests. Identify the smallest complete documentation/census contract and drift gate.
