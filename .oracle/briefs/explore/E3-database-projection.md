Explore schema registry and migration internals in depth: manifest fields, collision semantics, dependency parsing/enforcement, registered migration provenance, resource lookup, checksum/name/version drift, read-only probe, transactions, core contribution, and the cleanest generic database-projection reuse seam.
