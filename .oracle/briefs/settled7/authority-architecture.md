# Settled-plan wave 7 — authority-architecture
...
Challenge the proof-complete stable plan for any remaining alternate identity, admission, executable-byte, database/DDL, resource, documentation, backup/restore, or operational authority. Find a concrete bypass or declare clean. Do not rewrite the plan.
