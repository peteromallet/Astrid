# Settled-plan wave 3 — simplicity-scope
...
Challenge whether the complete stability-confirmed plan can achieve the frozen outcome with less work, fewer abstractions, fewer declarations, or fewer handoffs. Focus on speculative machinery and proof ceremony that does not pull its weight. Do not rewrite the plan.
