Inventory active tests, scripts, lints, docs, schemas, imports, generated files, and fixtures enforcing schema-pack.yaml, pack.yml/pack.json/flat manifests, fixed standard tuples, hard-coded first-party lists, or independent raw parsing. Distinguish active authorities from clearly historical references and suggest exact zero-legacy gates.
