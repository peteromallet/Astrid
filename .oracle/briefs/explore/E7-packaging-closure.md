Explore source and wheel packaging for manifests, SQL, Markdown, nested skills, component manifests, Python-adjacent assets, and opaque runtime resources. Identify current exclusions/hard-coded inclusions, recursive references, symlink/path risks, and the simplest clean-wheel resource-closure test.
