...
| Prompts | Runtime-owned immutable text bindings with named prompt slots and optimistic head checks; [SDK reference](https://github.com/peteromallet/Astrid/blob/032f65bcd84bd6360f83c260aa902c3a70cc0575/docs/reference/sdk.md) | General-versus-segment prompt semantics and frozen compilation into a generation request |
| References | Reusable subjects and canonical/used-as-input/depicts/inspired-by associations; [reference skill](https://github.com/peteromallet/Astrid/blob/032f65bcd84bd6360f83c260aa902c3a70cc0575/astrid/packs/references/skill/SKILL.md) | Shot input bindings with explicit generation roles; association alone does not wire model inputs |
| Video generation | `image_ref` and `image_end_ref`; [video contract](https://github.com/peteromallet/Astrid/blob/032f65bcd84bd6360f83c260aa902c3a70cc0575/docs/generation/31-video-contract.md) | Multiple timed anchors/reference inputs, video spans, and capability-specific lowering |
...
| Playback | Versioned child/parent timeline saves and managed renders; [rendering skill](https://github.com/peteromallet/Astrid/blob/032f65bcd84bd6360f83c260aa902c3a70cc0575/astrid/packs/rendering/skill/SKILL.md) | Explicit, reversible selection of a generated take versus a reference still |
