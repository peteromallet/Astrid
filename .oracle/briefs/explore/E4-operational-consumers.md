Trace every consumer of standard schema/database composition: application, writer/open, SDK invocation, kernel reads, doctor, backup, restore, CLI ownership, bridge, timeline helpers, rendering executors, and tests. Identify import-layer constraints and the single least-disruptive composition boundary.
